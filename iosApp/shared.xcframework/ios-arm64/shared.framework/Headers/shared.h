...
- (instancetype)initWithWinnerTeam:(id<SharedTeam>)winnerTeam winner:(NSString *)winner __attribute__((swift_name("init(winnerTeam:winner:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (id<SharedTeam>)component1 __attribute__((swift_name("component1()")));
- (NSString *)component2 __attribute__((swift_name("component2()")));
- (SharedGameStateFinished *)doCopyWinnerTeam:(id<SharedTeam>)winnerTeam winner:(NSString *)winner __attribute__((swift_name("doCopy(winnerTeam:winner:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *winner __attribute__((swift_name("winner")));
...
- (instancetype)initWithBlueDefender:(SharedBlueDefender *)blueDefender blueForward:(SharedBlueForward *)blueForward redDefender:(SharedRedDefender *)redDefender redForward:(SharedRedForward *)redForward gameState:(SharedGameState *)gameState dialogSate:(SharedDialogState * _Nullable)dialogSate __attribute__((swift_name("init(blueDefender:blueForward:redDefender:redForward:gameState:dialogSate:)"))) __attribute__((objc_designated_initializer));
...
- (SharedMainScreenState *)doCopyBlueDefender:(SharedBlueDefender *)blueDefender blueForward:(SharedBlueForward *)blueForward redDefender:(SharedRedDefender *)redDefender redForward:(SharedRedForward *)redForward gameState:(SharedGameState *)gameState dialogSate:(SharedDialogState * _Nullable)dialogSate __attribute__((swift_name("doCopy(blueDefender:blueForward:redDefender:redForward:gameState:dialogSate:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) SharedDialogState * _Nullable dialogSate __attribute__((swift_name("dialogSate")));
...
- (void)onSetScoreBlueScore:(int32_t)score __attribute__((swift_name("onSetScoreBlue(score:)")));
- (void)onSetScoreRedScore:(int32_t)score __attribute__((swift_name("onSetScoreRed(score:)")));
